import * as GETrequest from '../support/Requests.request.js';

/// <reference types="cypress" />

const MAKEpayload = require('../fixtures/MAKEpayload.json')
const MODELpayload = require('../fixtures/MODELpayload.json')
const VERSIONSpayload = require('../fixtures/VERSIONpayload.json')
const VEHICLESpayload = require('../fixtures/VEHICLESpayload.json')
